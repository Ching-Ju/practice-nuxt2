<template>
  <div id="contact" class="py-4 px-4 mx-0 mt-8 lg:mx-8">
    <div class="grid justify-content-between">
      <div class="col-12 md:col-5" style="margin-top:-1.5rem;">
        <div class="flex flex-wrap align-items-center justify-content-center md:justify-content-start md:mb-0 mb-3">
          <img :src="$_r(`layout/images/logo-${$store.getters['appState/logoColor']}.svg`)" alt="footer sections" width="50" height="50" class="mr-2">
