        ...
        <l-map :zoom="13" :center="[22.630409, 120.298343]" :options="{ contextmenu: true }">
          ...
          <v-marker-cluster>
            <l-marker
              ...
              @click="$refs.mapShowDetailDialogComponent.showDetailDialog = true"
              @contextmenu="$refs.mapAddToFavoriteDialogComponent.addToFavoriteDialog = true"
            >
...
const code = ''
const markers = [
  [22.630409, 120.298343],
  [22.630459, 120.298393]
]
</script>
