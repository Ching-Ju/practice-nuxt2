<template>
  <card-style2-component card-title="Badge">
    <template #cardBody>
      <h5>Numbers [Badge value='2']</h5>
      <div class="badges">
      ...
      <h5>Positioned Badge [i v-badge='2']</h5>
      ...
      <h5>Inline Button Badge [Button badge='8']</h5>
