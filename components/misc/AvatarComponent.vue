<template>
  <card-style2-component card-title="Avatar">
    <template #cardBody>
      <h5>Avatar Group</h5>
      ...
      <h5>Label - Circle [Avatar shape='circle']</h5>
      ...
      <h5>Icon - Badge [Avatar v-badge='4']</h5>
      <Avatar v-badge="4" icon="pi pi-user" class="mr-2" size="xlarge" />
    </template>
